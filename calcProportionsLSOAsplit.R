...
min$sec_lvl_1 <- percent(orig$sec_lvl_1 / orig$total_ppl_sec)
min$sec_lvl_2 <- percent(orig$sec_lvl_2 / orig$total_ppl_sec)
min$sec_lvl_3 <- percent(orig$sec_lvl_3 / orig$total_ppl_sec)
min$sec_lvl_4 <- percent(orig$sec_lvl_4 / orig$total_ppl_sec)
min$sec_lvl_5 <- percent(orig$sec_lvl_5 / orig$total_ppl_sec)
min$sec_lvl_6 <- percent(orig$sec_lvl_6 / orig$total_ppl_sec)
min$sec_lvl_7 <- percent(orig$sec_lvl_7 / orig$total_ppl_sec)
min$sec_lvl_8 <- percent(orig$sec_lvl_8 / orig$total_ppl_sec)
min$sec_lvl_9 <- percent(orig$sec_lvl_9 / orig$total_ppl_sec)
...
write.csv(min14, 'test.csv')
write.csv(min11, 'test2.csv')
